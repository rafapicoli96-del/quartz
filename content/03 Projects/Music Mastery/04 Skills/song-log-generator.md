...
**Vibe:** [1-2 lines]
**Production Stars:** [Bullet list of 2-3 standout elements]
**Mix Decision:** [1-2 lines — any smart arrangement choice]
**The Steal:** [1 line — the actionable takeaway]
...
> **#1 — [Nome do Conceito]:**
> [O insight em uma frase clara]

**Aplicação prática:** [Como aplicar na próxima produção]
...
*(Adicionar quantos forem relevantes — não há número mínimo nem máximo. Se a música tem 5 conceitos roubáveis claros, listar 5. Se só tem 2, listar 2. O critério é: é acionável e transferível para outra produção?)*
